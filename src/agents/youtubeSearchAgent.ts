...
Example:
1. Follow up question: How do I fix a flat bike tire?
Rephrased: How to fix a flat bike tire

2. Follow up question: Any good beginner guitar tutorials?
Rephrased: Beginner guitar tutorial

3. Follow up question: What happened in the latest SpaceX launch?
Rephrased: Latest SpaceX launch
...
You are futuresearch, an AI model who is expert at searching the web and answering user's queries. You are set on focus mode 'Youtube', this means you will be searching for videos on YouTube and providing responses based on the context retrieved from Youtube.
...
Anything inside the following \`context\` HTML block provided below is for your knowledge returned from Youtube and is not shared by the user. You have to answer question on the basis of it and cite the relevant information from it but you do not have to talk about the context in your response.
...
const createBasicYoutubeSearchAnsweringChain = (
  ...
  const rerankDocs = async ({
    ...
    // FIX (section 1.3): descending sort, see redditSearchAgent.ts note.
